	...
	function gfb_customizer_box() {
		...
		<div class="gfb-inner gfb-custom-copy">
			...
			?>
					<tr>
						<td colspan="3">
						<div class="gfb-highlight gfb-example"><?php printf( __( '<strong>Usage Example:</strong><div class="gfb-example">%1$s</div>', GFB_PLUGIN_DOMAIN ), htmlentities($default_output )); ?></div>
						</td>
					</tr>
			<?php
				}
			...
			?>
					<tr>
						<td colspan="3">
						<div class="gfb-highlight"><?php printf( __( '<strong>Preview:</strong><br /> %1$s', GFB_PLUGIN_DOMAIN ), do_shortcode( gfb_customized_footer( $this->get_field_value( 'gfb_output' ) ) ) ); ?></div>
						</td>
					</tr>
			<?php
				}
